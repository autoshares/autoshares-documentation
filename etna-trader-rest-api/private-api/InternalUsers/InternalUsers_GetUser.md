...
##### Description
This API endpoint enables you to retrieve information about a particular user by providing their internal identifier in Autoshares Trader in the request path.
