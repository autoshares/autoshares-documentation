...
{% tab title="Python" %}
{% code-tabs %}
{% code-tabs-item title="Creating a new trading account in Autoshares Trader" %}
```python
import requests
...
This method — `createNewTradingAccount()` — enables you to create a new trading account in Autoshares Trader. Information about the new trading account must be provided in the JSON format as the request's body. In response to this request, you'll receive a JSON file with the newly created account's information \(including its ID\). 
{% endtab %}
...
{% tab title="Python" %}
{% code-tabs %}
{% code-tabs-item title="Creating a new user in Autoshares Trader" %}
```python
import requests
...
This method — `createNewUser()` — enables you to create a new user in Autoshares Trader. Information about the new user must be provided in the JSON format as the request's body. In response to this request, you'll receive a JSON file with the newly created user's information \(including its ID\). 
{% endtab %}
