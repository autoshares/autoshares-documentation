...
| OrderStateId | This is the internal identifier of the order in Autoshares Trader. In most cases this information should not be used. |
...
| Id | This is the internal identifier of the fee in Autoshares Trader. |
