...
This POST endpoint enables you to verify an order before placing it in Autoshares Trader. This might be useful for ensuring that the user has properly constructed an order and prevent any issues related with defective orders.
